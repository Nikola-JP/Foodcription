    ...
    <nav className="flex justify-between items-center p-4 bg-white shadow-md">
      ...
      <ul className="flex space-x-6 text-gray-700 font-medium items-center">
        ...
        {!user ? (
          ...
          <>
            <li className="text-green-600 font-semibold">{user.imeKorisnika}</li>
            <li>
              <button onClick={onLogout} className="px-4 py-2 rounded-full border border-red-500 text-red-500 hover:bg-red-500 hover:text-white transition">
                Logout
              </button>
            </li>
          </>
